...
start_date_filter <- "2026-08-15"        # Example format: "2025-05-18" - Set to NULL for no date filter
end_date_filter <- "2026-08-15"          # Example format: "2025-05-18" - Set to NULL for no date filter
# ---- Required Libraries ----
library(tidyverse)
library(patchwork)
library(gridExtra)
