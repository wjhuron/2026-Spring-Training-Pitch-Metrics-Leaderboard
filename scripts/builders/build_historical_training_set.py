...
Usage:
  python3 scripts/builders/build_historical_training_set.py --sanity   # 2024, no weather, checks only
  python3 scripts/builders/build_historical_training_set.py            # full build all seasons + weather
"""
