...
Usage:
  python3 scripts/tools/live_catch_prob.py --game_pk 823598            # poll live
  python3 scripts/tools/live_catch_prob.py --game_pk 823598 --once     # one pass
  python3 scripts/tools/live_catch_prob.py --game_pk 823598 --all      # include 0.99 routine plays
