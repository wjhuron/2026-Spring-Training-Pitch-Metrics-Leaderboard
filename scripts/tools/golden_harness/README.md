...
```bash
python3 capture_inputs.py                    # once: freeze Sheets rows (~2 min)
PYTHONHASHSEED=0 python3 golden_run.py prestate   # snapshot data/, js/, index.html
PYTHONHASHSEED=0 python3 golden_run.py run BASE   # baseline (~4 min)
# ... make your code change ...
PYTHONHASHSEED=0 python3 golden_run.py run CHANGE
