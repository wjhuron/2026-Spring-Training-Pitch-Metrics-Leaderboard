...
same-hand ones. Pools come from scripts/platoon_splits.py, which is validated
...
Usage:  python3 scripts/platoon_cards.py [--role hitters|pitchers|both]
                                          [--outdir DIR]
"""
