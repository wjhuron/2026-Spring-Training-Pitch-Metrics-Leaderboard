...
Usage
-----
    python scripts/ops/fix_text_typed_supplements.py                   # scan
    python scripts/ops/fix_text_typed_supplements.py --apply           # repair all
    python scripts/ops/fix_text_typed_supplements.py --apply --teams ROC,AAA
"""
...
import scrapers.backfill_supplement as B  # noqa: E402
from scrapers.sheets_append import _col_letter, _sheets_retry  # noqa: E402
