...
Usage
-----
    python scripts/ops/fix_unformatted_blocks.py            # scan only (default)
    python scripts/ops/fix_unformatted_blocks.py --apply    # scan and repair
    python scripts/ops/fix_unformatted_blocks.py --apply --team ATL
"""
...
from scrapers.sheets_append import (  # noqa: E402
