...
Extends scripts/research/stuff/pitchingplus_loso_full.py (which derived the shipped 0.80)
...
Usage: python3 scripts/research/stuff/pitchingplus_command_loso.py [--seasons 2024,2025]
"""
import gc
import math
import os
...
import pipeline.commandplus as cp
