...
PROTOCOL (extends scripts/research/stuff/stuff_features_loso.py): for each held-out season
...
Usage: python3 scripts/research/stuff/stuff_pertype_atlas.py [--seasons 2021,2022,...]
                                              [--no-inter]
"""
import argparse
import gc
