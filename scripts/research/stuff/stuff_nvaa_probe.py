...
(same as scripts/research/stuff/stuff_velodiff_probe.py) PLUS Stuff-vs-Loc independence:
...
Usage: python3 scripts/research/stuff/stuff_nvaa_probe.py
"""
import json
import os
import pickle
...
from stuff_plus.train_stuff import (build_df, design, BASE_FEATS, _params_for,
