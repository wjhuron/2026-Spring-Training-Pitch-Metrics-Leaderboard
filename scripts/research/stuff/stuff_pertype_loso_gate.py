...
scripts/research/stuff/stuff_features_loso.py. A candidate is adoptable only if it beats
...
Usage: python3 scripts/research/stuff/stuff_pertype_loso_gate.py [--spec spec.json]
                                                  [--seasons 2021,...]
"""
import argparse
import gc
