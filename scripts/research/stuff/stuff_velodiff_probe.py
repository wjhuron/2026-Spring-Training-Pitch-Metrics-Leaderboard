...
Usage:
    python3 scripts/research/stuff/stuff_velodiff_probe.py            # stages 1-2 (fast)
    python3 scripts/research/stuff/stuff_velodiff_probe.py --ablate   # stage 3 (long)
"""
import argparse
import os
import pickle
...
from stuff_plus.train_stuff import (build_df, design, K_SCALE, BASE_FEATS,
