...
Usage examples:
  python3 scripts/research/comps/ford_comps.py                                  selection block
  python3 scripts/research/comps/ford_comps.py --hitter "Ford, Harry" --start 2026-06-01
  python3 scripts/research/comps/ford_comps.py --pitcher "Kolek, Bryce" --level mlb
  python3 scripts/research/comps/ford_comps.py --team ROC --role both
  python3 scripts/research/comps/ford_comps.py --team ROC --exclude "Jordan, Levi;Wallace, Cayden"
  python3 scripts/research/comps/ford_comps.py --pitcher "Cruz, Yovanny" --tab NEW   scratch-tab
...
from pipeline.utils import (safe_float as sf, NON_PA_EVENTS, BB_EVENTS,
...
# Pitcher fingerprint — REVISED 2026-08-03 (scripts/research/comps/comps_validation.py +
...
# AAA -> MLB level offsets for the outcome dims (scripts/research/comps/comps_validation.py:
    ...
    if _AAA_OFFSETS is None:
        try:
            ...
            print(f'  WARNING: {_AAA_OFF_PATH} missing — AAA-earned outcome '
                  'dims left on the AAA scale (run scripts/research/comps/comps_validation.py)')
            _AAA_OFFSETS = {}
