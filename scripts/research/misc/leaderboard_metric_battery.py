...
Usage:
  python3 scripts/research/misc/leaderboard_metric_battery.py --build     (~5-10 min)
  python3 scripts/research/misc/leaderboard_metric_battery.py --analyze
...
from pipeline.utils import BALL_RADIUS_FT, ZONE_HALF_WIDTH  # noqa: E402
