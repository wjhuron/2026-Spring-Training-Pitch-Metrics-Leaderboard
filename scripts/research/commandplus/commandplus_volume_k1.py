...
400 pitches (scripts/research/commandplus/commandplus_volume_test.py, replicated 6/6 seasons).
...
Usage: python3 scripts/research/commandplus/commandplus_volume_k1.py
"""
import math
import os
import random
