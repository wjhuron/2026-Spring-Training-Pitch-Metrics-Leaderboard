...
THE STAT.  The suppressor result (scripts/research/commandplus/commandplus_battery_2026_08.py
...
VERDICT: REJECTED, do not ship (scripts/research/commandplus/commandplus_xbb_worth.py). The
...
Usage: python3 scripts/research/commandplus/commandplus_xbb_build.py [--rebuild]
"""
import json
import math
import os
