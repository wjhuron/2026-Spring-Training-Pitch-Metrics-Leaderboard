...
(2) VOLUME — does the low-volume flattery found in 2026
    (scripts/research/commandplus/commandplus_volume_test.py: -0.105" at N=400) replicate on
...
Usage: python3 scripts/research/commandplus/commandplus_ladder_multiseason.py
"""
import gc
import math
import os
...
from pipeline.commandplus import MIN_CELL, count_group, is_eligible
...
def load_season(year):
    ...
    if year == 2026:
        ...
        del df
        gc.collect()
        from pipeline.commandplus import EXCLUDE_DESC, EXCLUDE_PT, HANDS
