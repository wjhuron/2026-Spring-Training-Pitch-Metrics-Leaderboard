"""Command+ volume test, follow-ups to scripts/research/commandplus/commandplus_volume_test.py.
...
from pipeline.commandplus import (MIN_CELL, MIN_POOL, count_group,
