...
split-half; see scripts/research/hitter/phase2_sdct_harness.py + phase2_sdplus_extensions.py).
...
Usage: python3 scripts/research/hitter/hitter_phase2_multiseason.py
"""
import json
import math
import os
