...
The shipped weights came from scripts/research/hitter/derive_weights_multiseason.py, which
...
Usage: python3 scripts/research/hitter/hitterplus_weight_sweep.py
"""
import math
import os
import pickle
