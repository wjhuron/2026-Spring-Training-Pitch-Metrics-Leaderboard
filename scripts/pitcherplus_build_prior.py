...
Usage: python3 scripts/pitcherplus_build_prior.py [--season 2025]
"""
import argparse
import json
import os
...
from pipeline_pitcherplus import (COMPONENTS, QUAL_N,   # noqa: E402
                                  SCALE_K, MIN_POOL)
...
def main(season):
    ...
    out = {
        ...
        'note': ('Prior-season Pitcher+ for the 70/30 projection blend. '
                 ...
                 'scripts/pitcherplus_build_prior.py) — NOT the retagged '
