...
Consumed by js/abs.js (zone overlay) and scripts/abs/abs_matrix_page.py.

Usage:
    python3 scripts/abs/abs_hitter_zones.py            # dry run: compare vs shipped file
    python3 scripts/abs/abs_hitter_zones.py --apply    # overwrite the shipped file
"""
import json
import os
import sys
