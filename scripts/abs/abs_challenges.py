...
Usage:
    python3 scripts/abs/abs_challenges.py                     # season to date
    python3 scripts/abs/abs_challenges.py --start 2026-07-01 --end 2026-07-19
    python3 scripts/abs/abs_challenges.py --limit 5           # smoke test
"""
