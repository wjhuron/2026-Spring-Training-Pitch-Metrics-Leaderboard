...
scripts/stuff_pertype_loso_gate.py and data/_stuff_pertype_gate.json).
...
(scripts/stuff_pertype_atlas.py): kin_eff carries its largest out-of-sample
...
Usage: python3 scripts/stuff_kinff_2026_battery.py
"""
import json
import os
import pickle
