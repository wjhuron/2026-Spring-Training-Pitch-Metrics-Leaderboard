...
READ-ONLY. Runs the validated ROC methodology (scripts/roc_tag_audit.py) across
...
Usage:
    python3 scripts/team_tag_audit.py             # report + per-team summary
    python3 scripts/team_tag_audit.py --csv       # + ~/Downloads CSV
    python3 scripts/team_tag_audit.py --plots     # + discriminant plots
    python3 scripts/team_tag_audit.py --tier Medium   # widen the tier filter
"""
import os, sys
