const COLUMNS = {
  ...
  pitcherBattedBall: [
    ...
    { key: 'barrelPctAgainst', label: 'Barrel%', format: Utils.formatPct, sortType: 'numeric', desc: 'Barrel rate against (denominator = BIP with valid EV)', group: 'batted_ball' },
  ...
  hitterBattedBall: [
    ...
    { key: 'barrelPct',   label: 'Barrel%',  format: Utils.formatPct, sortType: 'numeric', desc: 'Barrel rate (denominator = BIP with valid EV)', group: 'quality' },
    { key: 'xwOBAcon',   label: 'xwOBAcon', format: Utils.formatDecimal(3), sortType: 'numeric', desc: 'Expected wOBA on contact — avg xwOBA on BIP only', group: 'expected' },
  ...
  hitterSwingDecisions: [
    ...
    { key: 'izSwChase',   label: 'Z-Sw-Ch%',  format: Utils.formatPct, sortType: 'numeric', desc: 'Discipline spread (Z-Swing% − Chase%)', group: 'discipline' },
