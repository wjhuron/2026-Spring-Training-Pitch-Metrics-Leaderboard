const COLUMNS = {
  ...
  hitterBattedBall: [
    ...
    { key: 'bbPlus',     label: 'BB+',      format: Utils.formatInt, sortType: 'numeric', desc: 'Batted-ball contact quality: xwOBAcon indexed so 100 = league avg, regressed to league by sample (n0=60 BIP). Scaled to wRC+\'s spread, so 120 is as RARE as a 120 wRC+ — rarity, not run value: measured, one SD of BB+ carries about 13 points of same-season wRC+, because contact quality is one input to production, not all of it.', group: 'expected' },
