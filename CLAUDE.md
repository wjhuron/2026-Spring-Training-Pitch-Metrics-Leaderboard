...
- Savant's published runs park factor is shrunk: actual runs allowed move 1.67x it (LOSO, 2021-2026, innings-weighted), while xwOBA-based rates (hdERA, FIP) move 0.91x it. "Full park adjustment" and "the published factor" are not the same thing; say which one a constant is measured against.
